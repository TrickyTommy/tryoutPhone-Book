 ...
 */
class contactFragment : Fragment(), InterfaceView.View {
    ...
    override fun onSuccessGetAllContact(list: List<ResponseCoontact>) {
    ...
    override fun onSuccesDeleteContact(message: String, id: Int) {
        TODO("Not yet implemented")
    }
}